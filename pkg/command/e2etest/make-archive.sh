...
LDFLAGS="-X github.com/kubegems/opentofu/pkg/command/e2etest.tofuBin=./tofu$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/kubegems/opentofu/pkg/command/e2etest
