...
//
//     import oauthserver "github.com/kubegems/opentofu/pkg/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/kubegems/opentofu/pkg/command/testdata/login-oauth-server"
)
