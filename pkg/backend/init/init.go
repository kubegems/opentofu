...
import (
	...
	"github.com/kubegems/opentofu/pkg/backend"
	"github.com/kubegems/opentofu/pkg/encryption"
	"github.com/kubegems/opentofu/pkg/tfdiags"
	"github.com/zclconf/go-cty/cty"

	backendLocal "github.com/kubegems/opentofu/pkg/backend/local"
	backendRemote "github.com/kubegems/opentofu/pkg/backend/remote"
	backendAzure "github.com/kubegems/opentofu/pkg/backend/remote-state/azure"
	backendConsul "github.com/kubegems/opentofu/pkg/backend/remote-state/consul"
	backendCos "github.com/kubegems/opentofu/pkg/backend/remote-state/cos"
	backendGCS "github.com/kubegems/opentofu/pkg/backend/remote-state/gcs"
	backendHTTP "github.com/kubegems/opentofu/pkg/backend/remote-state/http"
	backendInmem "github.com/kubegems/opentofu/pkg/backend/remote-state/inmem"
	backendKubernetes "github.com/kubegems/opentofu/pkg/backend/remote-state/kubernetes"
	backendOSS "github.com/kubegems/opentofu/pkg/backend/remote-state/oss"
	backendPg "github.com/kubegems/opentofu/pkg/backend/remote-state/pg"
	backendS3 "github.com/kubegems/opentofu/pkg/backend/remote-state/s3"
	backendCloud "github.com/kubegems/opentofu/pkg/cloud"
)
