...
import (
	...
	copydir "github.com/kubegems/opentofu/pkg/copy"
...
NeedProvider:
	...
	for provider, version := range need {
		...
		// This is only intended to be temporary, see https://github.com/kubegems/opentofu/issues/266 for more information
